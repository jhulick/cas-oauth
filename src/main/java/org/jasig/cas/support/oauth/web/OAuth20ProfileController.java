...
public final class OAuth20ProfileController extends AbstractController {
    ...
    private final HazelcastInstance hazelcast = Hazelcast.newHazelcastInstance(new Config());
    ...
    protected ModelAndView handleRequestInternal(final HttpServletRequest request, final HttpServletResponse response)
        ...
        Map m = hazelcast.getMap("testmap");
        ...
        String t = accessToken.toString();

        HashMap tgtIdMap = (HashMap)m.get(t);
        String tgtId = (String)tgtIdMap.get("tgt");

        log.info("\n\n**** tgtId: " + tgtId + " **********\n\n");

        // get ticket granting ticket
//        final ServiceTicket serviceTicket = (ServiceTicket) ticketRegistry.getTicket(accessToken);
//        log.info("\n\n***** serviceTicket is: " + serviceTicket + " **** \n\n");
//        final TicketGrantingTicket ticketGrantingTicket = serviceTicket.getGrantingTicket();
//        log.info("\n\n***** ticketGrantingTicket is: " + ticketGrantingTicket + " **** \n\n");

        final TicketGrantingTicket ticketGrantingTicket = (TicketGrantingTicket) this.ticketRegistry.getTicket(tgtId);
        ...
        /* DEMO Code */
        jsonGenerator.writeStartObject();
        jsonGenerator.writeObjectField("role", "ADMIN");
        jsonGenerator.writeEndObject();
        /* END DEMO Code */
